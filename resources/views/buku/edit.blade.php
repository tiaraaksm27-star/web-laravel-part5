...
@section('main')
    <form action="{{ url('/buku.'.$DataBuku->id_buku) }}" method="POST">
        ...
        <textarea name="judul">{{ $DataBuku->judul }}</textarea>
        <br><br>

        <label>Pengarang</label>
        <textarea name="pengarang">{{ $DataBuku->pengarang }}</textarea>
        <br><br>

        <label>Tahun Terbit</label>
        <input type="number" name="tahun_terbit" value="{{ $DataBuku->tahun_terbit }}">
        <br><br>
